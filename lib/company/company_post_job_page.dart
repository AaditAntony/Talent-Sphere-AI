...
class CompanyPostJobPage extends StatefulWidget {
  ...
  @override
  State<CompanyPostJobPage> createState() =>
      _CompanyPostJobPageState();
}

class _CompanyPostJobPageState
    extends State<CompanyPostJobPage> {
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (v) =>
                v!.isEmpty ? "Enter job title" : null,
              ),
